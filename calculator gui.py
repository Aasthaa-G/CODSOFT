...
if __name__ == "__main__":
	...
	expression_field.grid(columnspan=12, ipadx=100)
	...
	equal = Button(gui, text=' = ', fg='black', bg='light pink',
				command=equalpress, height=4, width=12)
	equal.grid(row=5, column=2)

	clear = Button(gui, text='Clear', fg='black', bg='light pink',
				command=clear, height=4, width=12)
